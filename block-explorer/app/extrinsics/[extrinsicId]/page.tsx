      ...
      <CardContent>
        <div className="flex flex-col gap-6">
          ...
          {data.events && hasParsedEventsAvailableExtrinsics(data.events) ? (
            ...
            <p className="text-xs text-muted-foreground">No parsed events found, please refer to the events tab.</p>
          ) : null}
          {data.signer ? (
            <CardDetail.Wrapper>
                  ...
                  {data.proxyFee ? (
                    <div className="flex flex-wrap items-center gap-1">
                      ...
                      <div className="flex flex-wrap items-center gap-1 whitespace-normal">
                        Swapped{' '}
                        <TokenDisplay token={data.proxyFeeToken} amount={data.proxyFee?.swappedAmount} hideCopyButton />{' '}
                        to pay for gas
                      </div>
                    </div>
                  ) : null}
