  ...
  'inline-flex items-center justify-center rounded-[8px] text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline: 'border-white/25 bg-white/50 hover:bg-accent hover:text-accent-foreground dark:bg-[#090909]/50',
        secondary: 'bg-surface-card font-semibold text-secondary-foreground hover:bg-surface-hover-secondary',
      ...
      size: {
        ...
        xs: 'h-6 rounded-[6px] px-[5px]',
        icon: 'size-10',
        pagination: 'size-8 rounded-lg',
      },
    },
    defaultVariants: {
      variant: 'default',
