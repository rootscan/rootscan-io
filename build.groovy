                ...
                stage('prod') {
                    ...
                    steps {
                        script {
                            ...
                            redeploySCMAINProjects(APPS, 'rootscan-o-porcini', '/project/c-m-cjkvztpw:p-chkm4/workload/deployment')
                            redeploySCMAINProjects(APPS, 'rootscan-o-root', '/project/c-m-cjkvztpw:p-chkm4/workload/deployment')
                        }
                    }
                }
            }
