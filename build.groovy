                ...
                stage('prod') {
                    ...
                    steps {
                        script {
                            ...
                            redeploySCMAINProjects(APPS, 'rootscan-o-porcini', '/project/c-m-h8j7fnkg:p-8djdg/workload/deployment')
                            redeploySCMAINProjects(APPS, 'rootscan-o-root', '/project/c-m-h8j7fnkg:p-8djdg/workload/deployment')
                        }
                    }
                }
            }
